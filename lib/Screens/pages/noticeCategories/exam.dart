...
class ViewExamNotice extends StatelessWidget {
  @override
    ...
    return StreamBuilder(
      ...
      builder: (context,snapshot){
        ...
        Stream getdept(){
            ...
            return NoticeService().allexam;
          }else{
          if(userData.department=='fst'){
            return NoticeService().fstexam;
          }else if(userData.department=='cis'){
            return NoticeService().cisexam;
          }else if(userData.department=='pst'){
            return NoticeService().pstexam;
          }else if(userData.department=='sport'){
            return NoticeService().sportexam;
          }else {
            return NoticeService().nrexam;
          }
          }
