...
class HODDrawerpart extends StatefulWidget {
  @override
  _HODDrawerpartState createState() => _HODDrawerpartState();
}

class _HODDrawerpartState extends State<HODDrawerpart> {
  Widget useremail(){
    ...
    return Drawer(
         child: ListView(
            children:<Widget>[
              ...
              tabs(icon:Icon(Icons.home),name:'HodHome'),
